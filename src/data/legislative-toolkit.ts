...
export const billSections: BillSection[] = [
  {
    ...
    title: "Short Title",
    summary:
      'Establishes the bill\'s name as the "EDDM Consumer Choice Act of 2026" or "Every Door Delivers Only to the Willing Act."',
    keyProvisions: [
      '"Consumer Choice" framing emphasizes empowerment over restriction',
      "Alternative title creates memorable acronym (EDDOW)",
    ],
    legalBasis:
      'Strategic framing shift from failed 2007 "Do Not Mail Act" negative framing',
  },
  {
    number: 2,
    title: "Congressional Findings",
    summary:
      "Nine findings establishing the factual and legal basis for the legislation, including EDDM volume, regulatory gaps, environmental impact, and Supreme Court precedent.",
    keyProvisions: [
    ...
    legalBasis:
      "Congressional findings establish legislative record for court review and support constitutional defense under Central Hudson",
  },
  {
    number: 3,
    title: "Definitions",
    summary:
      'Defines nine key terms including "saturation mail" - advertising delivered to 90%+ of addresses on a route, not addressed to specific individuals.',
    keyProvisions: [
    ...
    legalBasis:
      "Definition structure parallels TCPA definitions for constitutional consistency",
  },
  {
    number: 4,
    title: "Opt-In Registry",
    summary:
      "Establishes the Saturation Mail Opt-In Registry at FTC with default NO delivery unless consumer affirmatively opts in.",
    keyProvisions: [
    ...
    legalBasis:
      "Opt-in model follows Netherlands precedent; FTC administration follows Do Not Call Registry model",
  },
  {
    number: 5,
    title: "Fees",
    summary:
      "Establishes fee structure for commercial senders accessing the registry, with nonprofit discounts.",
    keyProvisions: [
    ...
    legalBasis:
      'Fee structure parallels Do Not Call Registry ($20,700/year nationwide) with lower rates to preempt "prohibitive cost" arguments',
  },
  {
    number: 6,
    title: "Enforcement",
    summary:
      "Four-tiered enforcement: FTC penalties ($50K-$500K), USPS OIG investigation, State AG enforcement, and private right of action ($500-$1,500/piece).",
    keyProvisions: [
    ...
    legalBasis:
      "Private right of action modeled on TCPA (47 USC 227) which has generated $200M+ in settlements. This is the bill's most powerful enforcement mechanism.",
  },
  {
    number: 7,
    title: "Postal Service Cooperation",
    summary:
      "Requires USPS to not deliver saturation mail to non-opted-in addresses, provide address lists, train carriers, and report quarterly.",
    keyProvisions: [
    ...
    legalBasis:
      "Places policy control with FTC (independent) while operational execution remains with USPS, separating conflict of interest from decision-making",
  },
  {
    number: 8,
    title: "Consumer Education",
    summary:
      "Mandates FTC consumer education campaign including materials, multilingual resources, and post office notices.",
    keyProvisions: [
    ...
    legalBasis:
      "Addresses weakness of Do Not Call rollout where many consumers remained unaware of the registry",
  },
  {
    number: 9,
    title: "Annual Reports",
    summary:
      "Requires annual FTC reports to Congress and GAO studies at 3 years and every 5 years thereafter.",
    keyProvisions: [
    ...
    legalBasis:
      "Congressional oversight ensures program effectiveness is measured and problems identified early",
  },
  {
    number: 10,
    title: "Implementation Timeline",
    summary:
      "24-month phased implementation: 12 months planning, 6 months education, then enforcement begins with small sender delay.",
    keyProvisions: [
    ...
    legalBasis:
      "Addresses criticism of previous bills' unrealistic timelines; matches Do Not Call rollout timeline",
  },
  {
    number: 11,
    title: "Authorization of Appropriations",
    summary:
      "$15 million for first two years, then fees supplement appropriations.",
    keyProvisions: [
  ...
  },
  {
    ...
    title: "Exemptions",
    summary:
      "Minimal exemptions: government notices, first-class mail to named individuals, and periodicals. Political mail is NOT exempt.",
    keyProvisions: [
    ...
    legalBasis:
      "Minimal exemptions address criticism that previous bills were too porous; political mail inclusion addresses fairness concerns",
  },
  {
    number: 13,
    title: "Effective Date",
    summary:
      "Act takes effect on enactment; delivery prohibition begins 19 months after enactment.",
    keyProvisions: [
  ...
  },
  {
    ...
    legalBasis:
      "Standard severability clause protects core program from partial court invalidation",
  },
  {
    number: 15,
    title: "Preemption",
    summary:
      '"Floor, not ceiling" - establishes minimum federal protection; states may go further.',
    keyProvisions: [
    ...
    legalBasis:
      "Floor approach allows state experimentation and avoids federalism objections",
  },
];
...
export const keyStats: KeyStat[] = [
  ...
  {
    value: "100 million",
    label: "Trees cut annually for junk mail",
    source: "Center for Development of Recycling",
    category: "environmental",
  },
  {
    value: "51.5 million",
    label: "Metric tons of CO2 emissions annually",
    source: "VoLo Foundation",
    category: "environmental",
  },
  {
    value: "28 billion",
    label: "Gallons of water consumed annually",
  ...
  {
    value: "44%",
    label: "Of junk mail thrown away unopened",
    source: "EPA",
    category: "consumer",
  },
  {
    value: "848",
    label: "Junk mail pieces per household annually",
    source: "VoLo Foundation",
    category: "consumer",
  },
  {
    value: "89%",
    label: "Of Americans support a Do Not Mail registry",
  ...
  {
    value: "$320 million",
    label: "Annual taxpayer cost to dispose of junk mail",
    source: "Municipal studies",
    category: "economic",
  },
  {
    value: "$118 billion",
    label: "USPS cumulative losses since 2007",
    source: "USPS/GAO",
    category: "economic",
  },
  {
    value: "3 billion",
    label: "EDDM pieces delivered annually",
    source: "USPS",
    category: "economic",
  },
  ...
  {
    value: "$4.9 billion",
    label: "In mail-based fraud losses (2024)",
    source: "FBI IC3",
    category: "fraud",
  },
  {
    value: "$3.4 billion",
    label: "Annual elder fraud losses (all channels)",
    source: "FBI IC3",
    category: "fraud",
  },
  ...
  {
    value: "81%",
    label: "Of Dutch households opted OUT when given choice",
    source: "Netherlands municipal data",
    category: "international",
  },
  {
    value: "62",
    label: "Dutch municipalities using JA-sticker (of 342)",
    source: "March 2024 data",
    category: "international",
  },
  {
    value: "6,000+",
    label: "Metric tons of paper saved annually (Netherlands)",
...
export const legislatorFaqs: LegislatorFAQ[] = [
  ...
  // Precedent
  {
    ...
    answer:
      "The Netherlands JA-sticker system demonstrates that opt-in is legally permissible (Dutch Supreme Court upheld it in 2021), operationally feasible (62 municipalities implemented successfully), and popular (81% opted out, 92% satisfaction). Businesses adapted without collapse. This real-world evidence directly refutes industry predictions of economic disaster.",
    category: "precedent",
  },
  {
...
export const talkingPointsTabs: TalkingPointsTab[] = [
  {
    ...
    concerns: [
      ...
      {
        concern: '"USPS needs revenue"',
        response: "USPS lost $118B since 2007, junk mail hasn't saved it",
      },
    ],
  },
  {
    ...
    concerns: [
      {
        concern: '"What about nonprofit fundraising?"',
        response:
          "Nonprofits can still reach willing supporters; they pay 50% reduced fees",
      },
      {
        concern: '"What about small businesses?"',
        response:
          "Small senders get 6-month delay; targeted mail to named individuals unaffected",
      },
      {
        concern: '"What about USPS jobs?"',
        response:
          "Mail volume already declining; opt-in may improve mail quality and sustainability",
      },
      {
        concern: '"What about political mail?"',
        response:
          "Our bill does NOT exempt political mail, unlike previous failed bills",
      },
    ],
  },
  {
    ...
    concerns: [
      {
        concern: '"Our customers expect our mailings"',
        response: "Then they'll opt in, no problem",
      },
      {
        concern: '"This will hurt small businesses"',
        response:
          "Small local businesses increasingly prefer digital (lower cost, better targeting)",
      },
      {
        concern: '"EDDM is affordable"',
        response: "Affordable advertising that nobody sees isn't a bargain",
      },
      {
        concern: '"What about existing customers?"',
        response:
          "Targeted mail to named individuals is NOT affected, only saturation mail",
      },
    ],
  },
  {
    ...
    concerns: [
      {
        concern: '"What if I want some ads?"',
        response: "You can opt in, that's the whole point of consumer choice",
      },
      {
        concern: '"Is this hard to set up?"',
        response: "Three options: internet, phone, or simple mailbox sticker",
      },
      {
        concern: '"Will I miss important mail?"',
        response:
          "First-class mail, government notices, and newspapers are all exempt",
      },
      {
        concern: '"What if I change my mind?"',
        response: "You can opt in or out at any time through any method",
      },
    ],
  },
];
...
export const counterarguments: Counterargument[] = [
  // Economic
  {
    ...
    industryPosition:
      "Direct mail supports 460,000 American jobs. This legislation would devastate the industry and cause massive unemployment.",
    response:
      "The 460,000 figure includes all printing, paper manufacturing, and postal jobs, not just advertising mail. It doesn't distinguish saturation mail from other mail, counts some jobs multiple times, and is based on outdated 2007 data. The Netherlands' 81% opt-out rate did not cause economic collapse; businesses adapted.",
    oneLineResponse:
      "That counts all mail jobs, not just junk mail, and the Netherlands didn't collapse",
  },
  {
    id: "small-business",
    category: "economic",
    ...
    industryPosition:
      "Small local businesses depend on affordable EDDM to compete. This bill will hurt those who can least afford it.",
    response:
      'EDDM primarily benefits large national mailers, not small businesses. Small businesses increasingly prefer digital advertising (cheaper, more targeted). The bill protects small senders with a 6-month delayed enforcement period. The "small business" framing is industry PR strategy.',
    oneLineResponse:
      "Small businesses prefer digital; the bill gives them extra time anyway",
  },
  {
    id: "economy",
    category: "economic",
    ...
    industryPosition:
      "The direct mail industry contributes billions to GDP. Restricting it will harm economic growth.",
    response:
      "Producing unwanted goods that go straight to landfills is waste, not productivity. Resources would be reallocated, not destroyed. The $320 million in disposal costs are externalized to taxpayers. A full accounting would reduce the claimed economic benefit.",
  ...
  // Constitutional
  {
    ...
    industryPosition:
      "Commercial speech is protected. A Do Not Mail registry would unconstitutionally restrict advertisers' free speech rights.",
    response:
      'The Supreme Court rejected this argument in Rowan v. USPS (1970): "We categorically reject the argument that a vendor has a right under the Constitution or otherwise to send unwanted material into the home of another." The Do Not Call Registry survived identical challenges in Mainstream Marketing v. FTC (2004).',
    oneLineResponse:
      "Supreme Court already ruled advertisers can't force mail into homes (Rowan)",
  },
  {
    ...
    industryPosition:
      "Political speech receives the highest protection. Exempting political mail is constitutionally required.",
    response:
      "Political campaign advertising is functionally commercial speech, it solicits money and votes. The bill is content-neutral, treating all saturation mail equally. Candidates have many other channels. Politicians shouldn't exempt themselves from consumer protection.",
    oneLineResponse:
      "Politicians shouldn't exempt themselves; the bill treats all ads equally",
  },
  ...
  // Practical
  {
    ...
    industryPosition:
      "Managing a national opt-in registry would be operationally impossible. The logistics are too complex.",
    response:
      "We already run the Do Not Call Registry with 246+ million phone numbers. The Netherlands does it with simple physical stickers, no complex database needed. Technology has advanced dramatically since 2007. This is not a hard technical problem.",
    oneLineResponse:
      "We run a 246-million-number phone registry; this isn't harder",
  },
  {
    ...
    industryPosition:
      "An opt-in system will confuse consumers. They won't understand what they're signing up for.",
    response:
      "The current system is more confusing, consumers don't know what EDDM is or why they can't stop certain mail. Opt-in is simpler: no saturation mail by default; display sticker or register to receive. Netherlands consumers aren't confused (92% satisfaction). The bill mandates consumer education.",
  ...
  },
  {
    ...
    industryPosition:
      "Industry self-regulation through DMAchoice gives consumers an opt-out option. Government intervention is unnecessary.",
    response:
      "DMAchoice does NOT stop EDDM. It only covers member companies' addressed mail, saturation mail is explicitly excluded. Less than 10% of consumers know it exists. Compliance is voluntary with no enforcement. If self-regulation worked, 89% of consumers wouldn't want a government registry.",
  ...
  },
  {
    ...
    industryPosition:
      "If consumers don't want the mail, they can simply throw it away. This is a minor inconvenience.",
    response:
      "44% already do throw it away, that's the problem, not the solution. It shifts the burden to consumers (8 months of lifetime sorting). Environmental costs are real (100M trees, $320M disposal). Vulnerable populations are harmed (seniors sorting for scams).",
  ...
  // Postal
  {
    ...
    industryPosition:
      "USPS depends on advertising mail revenue to survive. Reducing volume will force taxpayer bailouts or service cuts.",
    response:
      "USPS has lost $118 billion since 2007, advertising mail hasn't saved it. The PAEA pre-funding mandate was the real problem (partially fixed in 2022). Mail volume is already declining 50% since 2001. Saturation mail cannot reverse this trend. The future is packages, not junk mail.",
  ...
  },
  {
    ...
    industryPosition:
      "18 USC 1725 establishes the mailbox monopoly. USPS has both the exclusive right AND obligation to deliver all legal mail.",
    response:
      "Congress created the mailbox monopoly and can modify it, that's what this bill does. USPS already exercises discretion (refusing hazardous materials, returning undeliverable mail). Consumer consent is a reasonable condition, as Rowan recognized homeowner privacy rights.",
  ...
  },
  {
    ...
    industryPosition:
      "Many consumers appreciate advertising mail and use it to find deals. Opt-in will make it harder for them.",
    response:
      "Those consumers can opt in, that's the entire point of consumer choice. In the Netherlands, 19% did exactly that and continue receiving mail. The current system doesn't serve either group well; it just forces everyone to receive mail they may not want.",
...
export const keyInnovations = [
  ...
  },
  {
    ...
    precedent:
      "Principled consistency, politicians should not exempt themselves",
  },
  {
...
export const constitutionalBasis = {
  rowanCase: {
    ...
    holding:
      'The Supreme Court upheld consumer rights to refuse mail, stating: "We therefore categorically reject the argument that a vendor has a right under the Constitution or otherwise to send unwanted material into the home of another."',
    significance:
      "Establishes that consumer privacy can override advertiser speech rights in the home context.",
  },
  centralHudson: {
    ...
    significance:
      "The four-part test for commercial speech restrictions. This bill satisfies all four prongs.",
  },
  mainstreamMarketing: {
    name: "Mainstream Marketing Services v. FTC",
    citation: "358 F.3d 1228 (10th Cir. 2004)",
    holding:
      'The Tenth Circuit upheld the Do Not Call Registry against First Amendment challenge, finding it "a reasonable fit with the government\'s interest in protecting the privacy of individuals."',
    significance:
      "Directly validates the registry model against identical constitutional arguments.",
  },
};
...
export const tableOfContents: TOCSection[] = [
  ...
  {
    id: "bill-summary",
    title: "Model Bill Summary",
    shortTitle: "Bill Summary",
  },
  {
    id: "section-analysis",
