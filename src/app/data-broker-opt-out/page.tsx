...
export default function DataBrokerOptOutPage() {
  ...
  const howToSchema = generateHowToSchema({
    ...
    description:
      "Step-by-step guide to removing your personal information from major data brokers to reduce junk mail.",
    totalTime: "PT2H",
      ...
      >
        ...
        <div className="prose max-w-none">
          <p style={{ color: "#374151" }}>
            <strong>Want to stop junk mail before it starts?</strong> Much of
            the addressed junk mail you receive, catalogs, credit offers,
            marketing letters, exists because data brokers sold your personal
            information to advertisers. By opting out of these databases, you
            can reduce junk mail at the source.
          </p>
          ...
          <p style={{ color: "#374151" }}>
            Data brokers are companies that collect, aggregate, and sell
            personal information. They gather data from:
          </p>
          <ul style={{ color: "#374151" }}>
            <li>
              <strong>Public records:</strong> Property records, voter
              registration, court records, birth/death records
            </li>
            <li>
              <strong>Commercial sources:</strong> Purchase history, warranty
              registrations, loyalty programs
            </li>
            <li>
              <strong>Online activity:</strong> Social media, browsing history,
              app usage
            </li>
            <li>
              <strong>Surveys and contests:</strong> Sweepstakes entries,
              product registrations
            </li>
          </ul>
          <p style={{ color: "#374151" }}>
            This data is packaged into consumer profiles and sold to marketers,
            who use it to send targeted advertising mail. When you wonder
            &quot;how did they get my address?&quot;, a data broker is often the
            answer.
          </p>
          ...
          >
            ...
            <p style={{ color: "#78350f" }}>
              Opting out of data brokers reduces <strong>addressed</strong> junk
              mail, mail with your name on it. It does NOT stop EDDM (Every Door
              Direct Mail) addressed to &quot;Postal Customer&quot; or
              &quot;Resident.&quot; EDDM doesn&apos;t use mailing lists at all,
        ...
        <div className="space-y-6 my-8">
          ...
          >
            ...
            <p className="text-gray-600 mb-4" style={{ color: "#4b5563" }}>
              One of the largest consumer data brokers, with data on over 2.5
            ...
            >
              <ul className="space-y-2" style={{ color: "#374151" }}>
                ...
                <li>
                  <strong>Phone:</strong> 1-877-774-2094
                </li>
                <li>
                  <strong>Time:</strong> 2-4 weeks to process
                </li>
              </ul>
            </div>
          </div>
          ...
          >
            ...
            <p className="text-gray-600 mb-4" style={{ color: "#4b5563" }}>
              Major data marketing company that also operates the Abacus catalog
              cooperative.
            </p>
            <div
              className="bg-white p-4 rounded-lg"
            ...
            >
              <ul className="space-y-2" style={{ color: "#374151" }}>
                <li>
                  <strong>Email:</strong> optout@epsilon.com (include full name
                  and address)
                </li>
                <li>
                  <strong>Phone:</strong> 1-866-267-3861
                </li>
                <li>
                  <strong>Mail:</strong> Epsilon, P.O. Box 1478, Broomfield, CO
                  80038
                </li>
                <li>
                  <strong>Time:</strong> 4-6 weeks to process
                </li>
              </ul>
            </div>
          </div>
          ...
          >
            ...
            <p className="text-gray-600 mb-4" style={{ color: "#4b5563" }}>
              Acquired BlueKai and Datalogix; maintains extensive consumer data
              for digital and direct marketing.
            </p>
            <div
              className="bg-white p-4 rounded-lg"
              style={{ backgroundColor: "#ffffff" }}
            >
              <ul className="space-y-2" style={{ color: "#374151" }}>
                <li>
                  ...
                  (scroll to &quot;Your Choices&quot;)
                </li>
                <li>
                  <strong>Email:</strong> privacy@oracle.com
                </li>
                <li>
                  <strong>Time:</strong> 30 days to process
                </li>
              </ul>
            </div>
          </div>
          ...
          >
            ...
            <p className="text-gray-600 mb-4" style={{ color: "#4b5563" }}>
              Primarily known for legal research but also maintains consumer
              data for risk assessment and marketing.
            </p>
            <div
              className="bg-white p-4 rounded-lg"
              style={{ backgroundColor: "#ffffff" }}
            >
              <ul className="space-y-2" style={{ color: "#374151" }}>
                <li>
                  <strong>Online:</strong>{" "}
                  <a
                    href="https://consumer.risk.lexisnexis.com/"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-blue-600 hover:underline"
                    style={{ color: "#2563eb" }}
                ...
                <li>
                  <strong>Phone:</strong> 1-888-332-8244
                </li>
                <li>
          ...
          >
            ...
            <p className="text-gray-600 mb-4" style={{ color: "#4b5563" }}>
              Cooperative database operated by Epsilon specifically for catalog
              marketers. If you receive lots of catalogs, Abacus likely has your
              data.
            </p>
            <div
              className="bg-white p-4 rounded-lg"
            ...
            >
              <ul className="space-y-2" style={{ color: "#374151" }}>
                <li>
                  <strong>Email:</strong> abacusoptout@epsilon.com
                </li>
                <li>
                  <strong>Mail:</strong> Abacus, P.O. Box 1478, Broomfield, CO
                  80038
                </li>
                <li>
                  <strong>Time:</strong> 6-8 weeks to process
                </li>
              </ul>
            </div>
          </div>
          ...
          >
            ...
            <p className="text-gray-600 mb-4" style={{ color: "#4b5563" }}>
              In addition to credit reporting, Experian maintains marketing data
              and sells mailing lists.
            </p>
            <div
              className="bg-white p-4 rounded-lg"
              style={{ backgroundColor: "#ffffff" }}
            >
              <ul className="space-y-2" style={{ color: "#374151" }}>
                <li>
                  <strong>Online:</strong>{" "}
                  <a
                    href="https://www.experian.com/privacy/opting-out"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-blue-600 hover:underline"
                    style={{ color: "#2563eb" }}
                  >
                    experian.com/privacy/opting-out
                  </a>
                </li>
                <li>
                  <strong>Note:</strong> This is separate from OptOutPrescreen
                  (credit offers)
                </li>
                <li>
                  <strong>Time:</strong> 4-6 weeks to process
        ...
        <div className="prose max-w-none">
          ...
          <p style={{ color: "#374151" }}>
            Manually opting out of all data brokers can take{" "}
            <strong>300+ hours</strong>. Paid services automate the process:
          </p>
        </div>
          ...
          >
            ...
            <tbody>
              <tr>
                ...
                <td className="px-4 py-3 border-b" style={{ color: "#374151" }}>
                  Quarterly scans, family plans available
                </td>
              </tr>
              <tr style={{ backgroundColor: "#f9fafb" }}>
                ...
                <td className="px-4 py-3 border-b" style={{ color: "#374151" }}>
                  From Surfshark VPN, automated tracking
                </td>
              </tr>
              <tr>
                <td
              ...
              <tr style={{ backgroundColor: "#f9fafb" }}>
                ...
                <td className="px-4 py-3 border-b" style={{ color: "#374151" }}>
                  Budget option, searches every 4 months
                </td>
              </tr>
            </tbody>
          </table>
        ...
        <div className="prose max-w-none">
          <div
            className="bg-amber-50 p-4 rounded-lg my-6"
            style={{ backgroundColor: "#fffbeb" }}
          >
            <p style={{ color: "#78350f" }}>
              <strong>Note:</strong> These services reduce addressed junk mail
              but cannot stop EDDM (Every Door Direct Mail) addressed to
              &quot;Postal Customer&quot; or &quot;Resident.&quot; For EDDM, we
              need a federal Do Not Mail registry,{" "}
          ...
          <ul style={{ color: "#374151" }}>
            <li>
              ...
              Stop prescreened credit and insurance offers (free)
            </li>
            <li>
              <strong>
                <Link
                  href="/reduce-junk-mail#step-2"
                  style={{ color: "#2563eb" }}
                >
                  DMAchoice.org
                </Link>
              ...
              Opt out of catalogs and marketing mail ($4-6)
            </li>
            <li>
              <strong>
                <Link href="/stop-catalog-mail" style={{ color: "#2563eb" }}>
                  CatalogChoice.org
                </Link>
                :
              </strong>{" "}
              Stop specific catalogs (free)
            </li>
          </ul>
        </div>
